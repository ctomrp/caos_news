...
urlpatterns = [
    ...
    # path('news/<int:news_id>/gallery/', pictures_gallery, name='pictures_gallery'),
    path('login/', login, name='login'),
    path('register/', register, name='register'),
    path('contact/', contact, name='contact'),
    path('create_news/',crear_noticia, name='create_news'),
    path('editor_dash/',editor_dash, name='editor_dash'),
    path('edit_news/',edit_news, name='edit_news'),
    # path('news_detail/', news_detail, name='news_detail'),
    # path('news_detail/<int:news_id>/', news_detail, name='news_detail'),
    path('news/<int:news_id>/', news_detail, name='news_detail'),
    path('news/<int:news_id>/', news_feedback, name='news_feedback'),
